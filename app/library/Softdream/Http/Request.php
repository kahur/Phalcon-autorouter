...
class Request extends \Phalcon\Http\Request {
    protected $uri;
    /**
     * @var \Mia\Http\Request\Map Description
     */
    protected $uriMap;
    /**
     ...
     */
    protected $uriParts;
    public function __construct(\Softdream\Http\Url\Map $map = null) {
    ...
    public function setMap(\Softdream\Http\Url\Map $map){
	$this->uriMap = $map;
    }
